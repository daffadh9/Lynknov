    ...
    <AuthLayout>
      <div className="flex flex-col space-y-8">
        <div className="flex flex-col space-y-2 text-center lg:text-left">
          <h2 className="text-2xl font-medium tracking-tight text-white">Masuk ke Lynknov</h2>
          <p className="text-sm text-[var(--color-text-secondary)]">
            Masukkan detail Anda untuk mengakses dashboard.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-5">
          <div className="space-y-4">
            ...
            <div className="space-y-2 relative group">
              <label htmlFor="email" className={`text-sm font-medium transition-colors duration-300 ${focusedField === 'email' ? 'text-purple-400' : 'text-white/80'}`}>Email</label>
              <div className="relative">
                <input 
                  ...
                  onBlur={handleBlur}
                  className="w-full h-12 px-4 rounded-xl bg-white/[0.02] border border-white/10 text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/60 focus:bg-white/[0.04] transition-all duration-300 relative z-10 hover:border-white/20 hover:bg-white/[0.03]"
                />
                <AnimatePresence>
                  {focusedField === 'email' && (
                    <motion.div 
                      ...
                      className="absolute inset-0 rounded-xl shadow-[0_0_15px_rgba(124,58,237,0.15),inset_0_0_0_1px_rgba(124,58,237,0.3)] z-0 pointer-events-none"
                    />
                  )}
                </AnimatePresence>
              </div>
            ...
            <div className="space-y-2 relative group">
              <div className="flex items-center justify-between">
                <label htmlFor="password" className={`text-sm font-medium transition-colors duration-300 ${focusedField === 'password' ? 'text-purple-400' : 'text-white/80'}`}>Password</label>
        ...
        <p className="text-center text-sm text-[var(--color-text-secondary)]">
          Belum punya akun?{" "}
          <Link href="/register" className="font-medium text-white hover:text-purple-400 transition-colors underline-offset-4 hover:underline">
            Daftar
          </Link>
        </p>
      </div>
